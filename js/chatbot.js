...
document.addEventListener('DOMContentLoaded', function() {
    ...
    async function askServer(text){
        ...
        try{
            ...
            if(!res.ok){ const e = await res.text().catch(()=>res.statusText); return 'Lỗi server: '+e + ' (status ' + res.status + ')'; }
    ...
    addMessage('bot','Xin chào! Gõ câu hỏi để mình truy vấn ChatGPT.');
});