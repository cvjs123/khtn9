...
// Build per-topic arrays from the full list (file contains 277 questions in 5 sections)
window.questions_hoa_by_topic = window.questions_hoa_by_topic || {};
// Known section sizes (as in this file): 49,47,42,43,41,65 = 287
const _hoaCounts = [49,89,43,41,65];
const _hoaLongNames = [
  'Kim loại – Phi kim',
